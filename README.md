...
** IMPORTANT NOTE FOR NEGATIVE DECLINATION:**  If your target has a negative Declination (e.g., `-00:26:43.28`), you **must** use an equals sign (`=`) between `--dec` and the value: `--dec=-00:26:43.28`. Otherwise, the command-line parser will mistake the minus sign for a new argument flag.
